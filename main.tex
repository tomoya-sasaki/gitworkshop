...
\author[Tomoya]{Tomoya Sasaki\footnote{This workshop is inspired by workshops by Suyeol Yun and Shiro Kuriwaki.}}
...
\begin{frame}{Other side benefits of Git/Github}
  \begin{columns}[c]
    ...
    \begin{column}{0.53\linewidth}
      ...
      \only<5|handout:3>{\includegraphics[width = 0.55\linewidth]{github_overleaf.png}} 
      \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Comparison to alternatives (Dropbox, Google Drive)}
  \begin{itemize}[<+->]
...
\begin{frame}{Next step}
  \begin{itemize}[<+->]
    \item Work with private repos $\leadsto$ you need to work with authentication
    \item (Gradually) learn how to use git in command lines
    \medskip
